...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"restore" : 					{
						"decimatorBitDepth" : [ 24.0 ],
						"decimatorDownsamplingRatio" : [ 1.0 ],
						"decimatorDryWet" : [ 0.0 ],
						"decimatorOffOn" : [ 0.0 ]
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 185.666672, 120.0, 30.0, 22.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 135.666672, 170.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "expr $i2 / $f1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 171.0, 80.0, 63.0, 22.0 ],
					"style" : "",
					"text" : "dspstate~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 650.0, 20.0, 80.0, 26.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 210.0, 70.0, 80.0, 26.0 ],
					"style" : "",
					"text" : "Decimator"
				}
				...
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							...
							"parameter_longname" : "decimatorDryWet",
...
, 			{
				"box" : 				{
					...
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
							"parameter_longname" : "decimatorOffOn",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 280.0, 20.0, 60.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 222.0, 10.0, 60.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
							"parameter_longname" : "decimatorBitDepth",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "float" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 136.0, 20.0, 84.0, 47.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 138.0, 10.0, 90.0, 47.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_linknames" : 1,
							"parameter_longname" : "decimatorDownsamplingRatio",
							"parameter_shortname" : "Downsamp. Ratio",
							"parameter_type" : 0,
							"parameter_mmin" : 1.0,
							"parameter_mmax" : 1000.0,
							"parameter_enum" : [ "0", "48000" ],
							"parameter_initial_enable" : 1,
...
,
					"varname" : "decimatorDownsamplingRatio"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 110.0, 220.0, 96.0, 22.0 ],
					"style" : "",
					"text" : "poly~ decimator"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 145.166672, 207.0, 145.166667, 207.0 ],
					"source" : [ "obj-12", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 195.166672, 157.0, 145.166672, 157.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 670.5, 207.0, 196.5, 207.0 ],
					"source" : [ "obj-25", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 790.5, 207.0, 196.5, 207.0 ],
					"source" : [ "obj-33", 2 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 289.5, 207.0, 170.833333, 207.0 ],
					"source" : [ "obj-5", 0 ]
				}
